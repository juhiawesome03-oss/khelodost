...
<div class="layout-sidebar-right layout-section">
  ...
  <div class="card-header bg-white">
    <ul class="nav nav-tabs card-header-tabs" id="betTabs" role="tablist">
      <li class="nav-item" role="presentation">
        <a class="nav-link active" href="#betslip" data-bs-toggle="tab" role="tab" aria-controls="betslip" aria-selected="true">
          Betslip
        </a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" href="#openbets" data-bs-toggle="tab" role="tab" aria-controls="openbets" aria-selected="false">
          Open Bets
        </a>
      </li>
    </ul>
  ...
  <div class="card-body tab-content">
    ...
    <div class="tab-pane fade" id="openbets" role="tabpanel">
      <p class="text-center text-muted">Please login to see your open bets.</p>
      <div class="text-center">
        <a href="login" class="text-primary">Login</a>
      </div>
    </div>
