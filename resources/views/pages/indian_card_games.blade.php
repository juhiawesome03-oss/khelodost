    ...
    <main class="layout-content-center layout-section">
        <div class="container indian-card-container">
            ...
            <div class="row row-cols-2 row-cols-md-4 g-2">
                <div class="col"><img src="{{ asset('images/24k-dragon.webp') }}" alt="Game 1" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Ace-of-Spades.webp') }}" alt="Game 2" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Agent-of-Heart.webp') }}" alt="Game 3" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Amulet-of-dad.webp') }}" alt="Game 4" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Animal-madness.webp') }}" alt="Game 5" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Bakers-treat.webp') }}" alt="Game 6" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Banana-rock.webp') }}" alt="Game 7" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Battle-royal.webp') }}" alt="Game 8" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/24k-dragon.webp') }}" alt="Game 9" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Ace-of-Spades.webp') }}" alt="Game 10" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Agent-of-Heart.webp') }}" alt="Game 11" class="game-image">
                </div>
                <div class="col"><img src="{{ asset('images/Amulet-of-dad.webp') }}" alt="Game 12" class="game-image">
                </div>
            </div>
        </div>
    </main>
