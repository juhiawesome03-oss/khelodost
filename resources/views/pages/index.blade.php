        ...
        <div class="container">
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-nowrap gap-2 overflow-auto">
                        <a href="javascript:void(0);" class="btn btn-outline-secondary btn-tab active px-2 py-1"
                            data-tab="originals">Originals</a>
                        <a href="javascript:void(0);" class="btn btn-outline-secondary btn-tab px-2 py-1"
                            data-tab="crash">Crash Games</a>
                        <a href="javascript:void(0);" class="btn btn-outline-secondary btn-tab px-2 py-1"
                            data-tab="live">Live Roulette</a>
                    </div>
                    <div class="d-flex gap-2">
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle games_scroll"
                            data-scroll="-150">&lt;</a>
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle games_scroll"
                            data-scroll="150">&gt;</a>
                    </div>
                ...
                <div class="all_games d-flex overflow-auto p-2 gap-3">
                    <div id="originals" class="tab-content d-flex gap-2">
                        <img src="{{ asset('images/29b.webp') }}" class="rounded tab-img" alt="Original 1">
                        <img src="{{ asset('images/32c.webp') }}" class="rounded tab-img" alt="Original 2">
                        <img src="{{ asset('images/29b.webp') }}" class="rounded tab-img" alt="Original 3">
                        <img src="{{ asset('images/32c.webp') }}" class="rounded tab-img" alt="Original 4">
                        <img src="{{ asset('images/29b.webp') }}" class="rounded tab-img" alt="Original 5">
                        <img src="{{ asset('images/32c.webp') }}" class="rounded tab-img" alt="Original 6">
                    </div>
                    <div id="crash" class="tab-content d-none gap-2">
                        <img src="{{ asset('images/29b.webp') }}" class="rounded tab-img" alt="Crash 1">
                    </div>
                    <div id="live" class="tab-content d-none gap-2">
                        <img src="{{ asset('images/32c.webp') }}" class="rounded tab-img" alt="Live 1">
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-0">
                    <table class="table table-bordered text-center mb-0">
                        <thead class="table-light">
                            <tr>
                                <th class="text-start">⚾Cricket</th>
                                <th>1</th>
                                <th>X</th>
                                <th>2</th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-start">Today 20:00 - Pakistan vs Sri Lanka</td>
                                <td>1.17</td>
                                <td>0</td>
                                <td>2.23</td>
                            </tr>
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle providers_scroll"
                            data-scroll="-300">&lt;</a>
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle providers_scroll"
                            data-scroll="300">&gt;</a>
                    </div>
                ...
                <div class="card-body overflow-hidden">
                    <div class="providers_slider d-flex flex-nowrap overflow-auto gap-3">
                        ...
                        <div class="row flex-shrink-0" style="min-width:100%;">
                            ...
                            <div class="col-4 d-flex flex-column gap-2">
                                <div class="card-slide"><img src="{{ asset('images/ONLYPLAY.png') }}" class="provider-img"
                                        alt="OnlyPlay"></div>
            ...
            <div class="card shadow-sm mb-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle cards_scroll"
                            data-scroll="-300">&lt;</a>
                        <a href="javascript:void(0);" class="btn btn-outline-dark btn-sm rounded-circle cards_scroll"
                            data-scroll="300">&gt;</a>
                    </div>
